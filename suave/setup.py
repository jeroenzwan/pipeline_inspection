...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'spiral_search_mock = suave.spiral_search_mock:main',
            'follow_pipeline = suave.follow_pipeline_lc:main',
            'follow_pipeline_mock = suave.follow_pipeline_mock:main',
            'thruster_monitor = suave.thruster_monitor:main',
            'battery_monitor = suave.battery_monitor:main',
            'maintain_motion_mock = suave.maintain_motion_mock:main',
            'maintain_motion = suave.maintain_motion:main',
            'recharge = suave.recharge_lc:main',
